...
#ifndef NUMERIC_PRIMITIVES_CORE_SWIFT_H
#define NUMERIC_PRIMITIVES_CORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Numeric_Primitives_Core",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
