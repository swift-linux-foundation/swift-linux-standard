...
#ifndef TERMINAL_INPUT_PRIMITIVES_SWIFT_H
#define TERMINAL_INPUT_PRIMITIVES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Terminal_Input_Primitives",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
