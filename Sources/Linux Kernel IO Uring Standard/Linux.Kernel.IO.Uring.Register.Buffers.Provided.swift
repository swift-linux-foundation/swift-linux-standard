...
// ===----------------------------------------------------------------------===//
    ...
    extension Kernel.IO.Uring.Register.Buffers {
        ...
        public struct Provided {
            ...
            public static let register = Kernel.IO.Uring.Register.Opcode(rawValue: 22)

            /// Unregisters a provided buffer ring.
            ///
            /// - Linux: `IORING_UNREGISTER_PBUF_RING`
            public static let unregister = Kernel.IO.Uring.Register.Opcode(rawValue: 23)

            /// Queries provided buffer ring status (kernel 6.4+).
            ///
            /// - Linux: `IORING_REGISTER_PBUF_STATUS`
            public static let status = Kernel.IO.Uring.Register.Opcode(rawValue: 26)
        }
    }
